...
public class NuevaPersona extends JFrame {
	...
	public NuevaPersona() {
		...
		JLabel docu = new JLabel("introduzca el valor:");
		docu.setBounds(39, 102, 108, 20);
		contentPane.add(docu);

		txtnifnie = new JTextField();
		txtnifnie.setBounds(143, 102, 123, 20);
		contentPane.add(txtnifnie);
		txtnifnie.setColumns(10);
		...
		btnaceptar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				java.util.Date fechaelegida = (Date) spinnerFecha.getValue();
				...
				if(nif.isSelected() && nie.isSelected())
					...
					if(!nif.isSelected() && !nie.isSelected())
						errores +="\n Hay que marcar uno de los 2:NIF o NIE";
